export default function Terminos(){return <main style={{padding:16}}><h1>Términos</h1></main>};
export default function Terminos() {
  ...
  return (
    <main style={{ maxWidth: 780, margin: "40px auto", padding: "0 16px", lineHeight: 1.55, fontFamily: "system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Helvetica,Arial,sans-serif" }}>
      <h1 style={{ fontSize: "1.6rem", margin: "0 0 12px" }}>Términos y Condiciones</h1>
      <small style={{ opacity: 0.7 }}>Última actualización: {fecha}</small>

      <h2 style={{ fontSize: "1.15rem", margin: "24px 0 8px" }}>1. Descripción</h2>
      <p><b>RainbowGold</b> es una miniapp de juego “tap” integrada en World App. El objetivo es jugar, acumular puntos (RBGp) y realizar compras opcionales dentro de la app.</p>

      <h2 style={{ fontSize: "1.15rem", margin: "24px 0 8px" }}>2. Uso bajo tu responsabilidad</h2>
      ...
      <h2 style={{ fontSize: "1.15rem", margin: "24px 0 8px" }}>5. Conducta y trampas</h2>
      ...
      <h2 style={{ fontSize: "1.15rem", margin: "24px 0 8px" }}>6. Propiedad intelectual</h2>
